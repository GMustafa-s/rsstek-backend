					...
					<div class="container">
						<div class="box">
							<ul class="breadcrumbs viewport-holder slideDown">
								...
								<li><a href="{{ route('face.mask.detector') }}">{{$tr->setSource('en')->setTarget($site_language)->translate('Face Mask Detector')}}</a></li>
							</ul>
							<div class="text">
					...
					<div class="post">
						<div class="viewport-holder slideDown">
							...
							<div class="text">
                                ...
                                The Face Mask Detector module is designed to monitor compliance with security measures in a pandemic or epidemic - wearing a medical mask as a means of personal protection.')}}
                                </p>
						...
						<div class="viewport-holder slideDown delay-1">
							...
							<div class="text">
								<ul>
									...
									<li>
                                    {{$tr->setSource('en')->setTarget($site_language)->translate('The detector analyzes the stream, finds faces and determines if they have a mask.')}}
                                    </li>
									<li>
                                    {{$tr->setSource('en')->setTarget($site_language)->translate('An additional script closes dry contacts, initiating a speakerphone announcement and sends a violation message.')}}
                                    </li>

								</ul>
								<p>
                                    {{$tr->setSource('en')->setTarget($site_language)->translate('The functionality can be expanded by connecting additional scripts. Eliminated false positives on faces that are not visible in the frame.')}}
                                </p>
							</div>
						</div>
					</div>
