...
class IndustriesSectionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        'slug' => 'internal-factors-security'
        ...
        'slug' => 'technical-service-security'
        ...
        DB::table('industries_security_sections')->insert([
            ...
            'slug' => 'effective-authentication-system'
        ...
        DB::table('industries_security_sections')->insert([
            ...
            'slug' => 'security-and-loss-prevention'
            ...
            'slug' => 'improving-marketing-strategies'
        ...
        DB::table('industries_security_sections')->insert([
            ...
            'slug' => 'constant-monitoring-of-goods'
            ...
            'slug' => 'site-security-and-occupational-safety'
